        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl text-white">SportHub</span>
            </div>
            <p className="text-gray-400">
              Your one-stop platform for discovering and booking sports venues. Play your favorite sports anytime, anywhere.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>123 Sports Ave, NY 10001</span>
              </li>
            </ul>
